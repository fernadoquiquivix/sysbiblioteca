			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmRegistro">
						...
						<select class="form-control input-sm" id="TusuarioSelect" name="TusuarioSelect">
						<option value="A">Selecciona</option>
						<option value="B">Bibliotecario</option>
						<option value="C">Auxiliar Bibliotecario</option>
					    </select>
<br>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="frmRegistroU">
							...
							<label>Password</label>
						<input type="text" class="form-control input-sm" name="passwordU" id="passwordU">

						<label>Tipo de Usuario</label>
						<select class="form-control input-sm" id="TusuarioSelectU" name="TusuarioSelectU">
						<option value="A">Selecciona</option>
						<option value="B">Bibliotecario</option>
						<option value="C">Auxiliar Bibliotecario</option>
					    </select>
		...
		function agregaDatosUsuario(idusuario){
			...
			$.ajax({
				...
				success:function(r){
					...
					$('#TusuarioSelectU').val(dato['tipousuario']);
				}
			});
		}
				...
				$.ajax({
					...
					success:function(r){
						...
						if(r==1){
							...
							alertify.error("error Fallo al Guardar");
						}
					}
				});
			});
